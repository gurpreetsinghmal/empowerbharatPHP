        ...
        <div class="container mx-auto px-4">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-12">
                        ...
                        <a class="text-slate-600 active hover:text-green-600" href="join.php">Join Us</a>
            ...
            <div id="navbarContent" class="md:hidden hidden">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                        ...
                        <a class="text-slate-600 active block py-2 hover:text-green-600" href="join.php">Join Us</a>
