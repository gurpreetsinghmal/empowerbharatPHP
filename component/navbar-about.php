        ...
        <div class="container mx-auto px-4">
            <div class="flex h-16 items-center justify-between">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-12">
                        ...
                        <a class="text-slate-600  active hover:text-green-600" href="about.php">About US</a>
                        ...
                        <a class="text-slate-600  hover:text-green-600" href="team.php">Team</a>
                    </div>
                </div>
                <div class="md:hidden">
            ...
            <div id="navbarContent" class="md:hidden hidden">
                ...
                <a class="text-slate-600   block py-2 hover:text-green-600" href="index.php">Home</a>
                        <a class="text-slate-600  active block py-2 hover:text-green-600" href="about.php">About US</a>
