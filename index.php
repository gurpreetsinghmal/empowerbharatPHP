    ...
    <div>
        <div class="container mx-auto p-4 my-6">
            ...
            <div class="md:flex w-full mb-6">
                <div class="md:w-1/3 leading-loose">Empower Bharat-” An Initiative to Revive Rural India'', launched on
                    ...
                    self-reliant.
                    Our model is designed to address the key underlying problems of development in rural villages and
                    small towns, through a practical and sustainable process. </div>
                <div class="w-full md:flex justify-end md:ml-20 ">
            ...
            <div>
                <a href="#">
                    <span class="p-3 px-5 cursor-pointer bg-green-800 text-white rounded-[15px]">
                        Read more ></span>
                </a>
            </div>
                            ...
                            <div class="">
                                        ...
                                        <div class="flex ">
                                           ...
                                           -440 -7z" />
                                            ...
                                            <div class="md:leading-loose text-xs md:text-xl md:h-40 flex items-center p-4 ">
                                                One of the biggest issues for our rising nation is the stark difference
                                                in
                                                income distribution, consumption, and quality of life between rural and
                                                urban
                                                India. Empower Bharat was launched on 15th August 2021.
                                            </div>
                                ...
                                <div class="md:mt-32 mt-40">
                                    <div class="flex md:w-1/2 justify-center mx-auto">
                                        <div>
                                            <img class="md:w-24 md:h-24 w-20 h-20 ring-2 ring-green-800 rounded-full" src="https://www.seekpng.com/png/detail/34-345203_ruth-soukup-profile-blue-circle-flipped-circle-profile.png" />
                                        </div>
                                        <div class="text-white text-sm md:text-lg ml-6 flex flex-col justify-evenly">
                                            <div class="text-green-800 font-bold">KOMAL RAWAT</div>
                                            <div>Designer,</div>
        ...
        <div class="container mx-auto p-4 my-6">
            ...
            <div class="tracking-widest flex-wrap mb-6 flex items-center justify-center text-green-800 font-bold">
                ...
                <div class="md:w-1/3 w-1/ mb-3">
                    ...
                    <div class=" flex justify-center items-center">
                        <img class="h-16" src="images/partner/Techno minds logo.jpg" />
                    </div>
                </div>
                <div class="md:w-1/3 w-1/ mb-3">
                    <div class="text-center font-thin p-4">Corporate Partner</div>
                    <div class=" flex justify-center items-center">
                        <img class="h-16" src="images/partner/Local wale logo.png" />
                    </div>
                </div>
                <div class="md:w-1/3 w-1/ mb-3">
                    <div class="text-center font-thin p-4">Social Partner</div>
                    <div class=" flex justify-center items-center">
                        <img class="h-16" src="images/partner/Khabariya News Logo.jpg" />
                    </div>
                </div>
                <div class="md:w-1/3 w-1/ mb-3">
                    <div class="text-center font-thin p-4">College Festival Partner</div>
                    <div class=" flex justify-center items-center">
                        <img class="h-16" src="images/partner/Job U want logo.jpg" />
                    </div>
                </div>
